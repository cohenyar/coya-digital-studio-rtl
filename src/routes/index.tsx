        ...
        <div className="grid lg:grid-cols-[300px_1fr] gap-10 items-center max-w-4xl mx-auto">
          ...
          <div>
            ...
            <p className="mt-5 text-white/70 leading-relaxed text-lg whitespace-pre-line">
              היי אני ירין כהן ואני בניתי את האתר הזה מאפס מאמץ ומאה אחוזים נתינה&nbsp; &nbsp; &nbsp; &nbsp; COYA&nbsp;נבנתה מתוך מטרה לעזור לעסקים קטנים ובינוניים להיראות גדולים יותר, לעבוד חכם יותר ולהשתמש בטכנולוגיה בצורה פרקטית. המיקוד שלנו הוא לא רק עיצוב יפה, אלא תוצאה עסקית: יותר אמון, יותר פניות, פחות עבודה ידנית.
            </p>
          </div>
        </div>
      </Section>
