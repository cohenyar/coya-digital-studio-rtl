...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://coya-digital-studio-rtl.lovable.app/__l5e/assets-v1/d36078bd-d7e4-499d-a833-0cdcde29ed97/og-image.jpg",
    ...
    links: [{ rel: "canonical", href: "https://coya-digital-studio-rtl.lovable.app/" }],
  }),
  component: Home,
});
