...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "רוצים להתחיל פרויקט? השאירו פרטים, דברו איתנו בוואטסאפ או קבעו שיחת ייעוץ." },
      { property: "og:title", content: "צור קשר | COYA" },
      { property: "og:description", content: "בואו נדבר על הפרויקט הבא שלכם." },
