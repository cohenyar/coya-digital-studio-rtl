...
export const Route = createFileRoute("/websites")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "בניית אתרים מקצועיים לעסקים — מהירים, רספונסיביים, מותאמים ל-SEO, ומעוצבים לפי המותג שלכם." },
      { property: "og:title", content: "בניית אתרים לעסקים | COYA" },
      { property: "og:description", content: "אתרי עסקים מעוצבים, מהירים ומוכנים לצמיחה." },
      { property: "og:url", content: "/websites" },
    ],
