      ...
      <div className="container-x py-16 grid gap-10 md:grid-cols-5">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/ai-systems" className="text-white/70 hover:text-white">{t("nav.aiForBusiness")}</Link></li>
            <li><Link to="/ai-avatars" className="text-white/70 hover:text-white">{t("nav.aiAvatars")}</Link></li>
            <li><Link to="/ai-ads" className="text-white/70 hover:text-white">{t("nav.aiAds")}</Link></li>
            <li><Link to="/ai-videos" className="text-white/70 hover:text-white">{t("nav.aiVideos")}</Link></li>
          </ul>
        </div>
